...
class Sprite(pygame.sprite.Sprite):
    ...
    def setRectPosition(self):
        screenSize = Constantes().screenSize
        counter = Constantes().charCounter
        move = 0
        ...
        if counter % 2 == 0:
            ...
            self.rect.x = screenSize[
                0] - self.__width - screenSize[0]//5 + move
    ...
    def move(self, 
        ...
        self.rect.center = round(
            self.position.x), round(self.position.y)
